...
#define  TIMER1_TCNT1    *((volatile   u8*) 0x4C)
#define  TIMER1_OCR1A    *((volatile   u8*) 0x4A)
#define  TIMER1_OCR1B    *((volatile   u8*) 0x48)
#define  TIMER1_ICR1     *((volatile   u8*) 0x46)
...
#define  TIMER2_ASSR2     *((volatile   u8*) 0x43)
